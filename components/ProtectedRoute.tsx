...
export const EditorRoute = MakeProtectedRoute(["user", "editor", "admin"]);
export const ApproverRoute = MakeProtectedRoute(["approver", "admin"]);
export const UserRoute = MakeProtectedRoute(["user", "editor", "approver", "admin"]);
