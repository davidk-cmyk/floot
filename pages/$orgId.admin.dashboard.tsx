...
const DashboardPage = () => {
  ...
  const orgId = authState.type === 'authenticated' ? authState.organizationId : '';
        ...
        <section className={styles.quickActionsSection}>
          ...
          <div className={styles.quickActionsGrid}>
            ...
            <QuickActionCard
              ...
              to={`/${orgId}/admin/acknowledgements`}
              color="purple"
            />
          </div>
        </section>
        ...
        <section className={styles.portalsSection}>
          <div className={styles.quickActionsGrid} style={{ gridTemplateColumns: '1fr' }}>
            <QuickActionCard
              ...
              to={`/${orgId}/admin/settings#portals`}
              color="green"
            />
          </div>
        </section>
