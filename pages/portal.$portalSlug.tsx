...
import styles from "./portal.$portalSlug.module.css";
  ...
  if (portalSlug?.startsWith(':')) {
    return (
      <div className={styles.messageContainer}>
        ...
        <p className={styles.exampleText}>Example: <code>/portal/public</code> or <code>/portal/internal</code></p>
      </div>
    );
  }
      ...
      return (
        <div className={styles.messageContainer}>
          ...
          {authState.type === 'unauthenticated' && (
            <p>Please <Link to={`/login?redirect=/portal/${portalSlug}`}>log in</Link> to continue.</p>
          )}
        </div>
      );
    }
